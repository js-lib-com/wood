 ...
 * implements server side logic but forward server services requests to build context.
 * <p>
...
public class ForwardFilter implements Filter {
	...
	public void init(FilterConfig config) throws ServletException {
		...
		log.trace("Initialize filter |%s#%s|.", servletContext.getServletContextName(), config.getFilterName());
		...
		if (urlPatterns != null) {
			log.debug("Forward filter URL patterns |%s|.", urlPatterns);
	...
	static String forwardPath(File projectRoot, String requestPath) {
		...
		// http://localhost/site-preview/res/compos/dialog/sixqs/site/controller/MainController/getCategoriesSelect.rmi
