...
public class WoodTestCase {
	...
	protected static <T> T newInstance(String className, Object... args) {
		return Classes.newInstance(className, args);
	}

	protected static <T> T newInstance(Class<T> clazz, Object... args) {
		return Classes.newInstance(clazz.getName(), args);
	}
