...
public class ComponentAggregationTest {
    ...
    public void GivenSimpleAggregation_ThenIncludeChildLayout() {
        ...
        String compoHTML = "<section xmlns:w='js-lib.com/wood'>" + //
                "	<h1>Component</h1>" + //
    ...
    public void GivenAggregationOnStandaloneTemplate_ThenIncludeResolvedTemplate() {
        ...
        String childHTML = "<div w:template='res/template' xmlns:w='js-lib.com/wood'>" + //
    ...
    public void GivenAggregationOnStandaloneTemplate_ThenMergeAttributes() {
        ...
        String templateHTML = "<article id='template' name='template' class='template' xmlns:w='js-lib.com/wood'>" + //
                "	<section w:editable='section'></section>" + //
                "</article>";
        when(templateLayout.getReader()).thenReturn(new StringReader(templateHTML));

        String childHTML = "<div data-cfg='multi-select:true' name='child' class='container' w:template='res/template' xmlns:w='js-lib.com/wood'>" + //
