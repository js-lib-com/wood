...
public class Variables implements IVariables
{
   ...
   */
  @Override
  public void setAssetVariables(IVariables assetVariables)
  {
    this.assetVariables = (Variables) assetVariables;
  }

  @Override
  public void setThemeVariables(IVariables themeVariables)
  {
    this.themeVariables = (Variables) themeVariables;
  }
