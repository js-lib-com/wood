...
public final class Project {
	...
	/**
	 * Scan for build files and cache resulted meta data. This method is specifically designed for builder class;
	 ...
	 * @see #layouts
	 */
	public Set<ILayoutFile> getLayouts() {
	...
	public boolean hasScriptDiscovery() {
		return scriptDependencyStrategy == ScriptDependencyStrategy.DISCOVERY;
	}
