...
public class Project {
	...
	public IScriptFile getPreviewScript(FilePath previewFile) {
		...
		/*
		 * // scan script dependencies only if discovery is enabled if (scriptDependencyStrategy ==
		 * ScriptDependencyStrategy.DISCOVERY) { previewScript.scanDependencies(classScripts); }
		 */
	...
	public Collection<ScriptFile> previewScriptFiles() {
		...
		/*
		 * // scan script files dependencies only if discovery is enabled if (scriptDependencyStrategy ==
