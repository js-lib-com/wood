...
class SubOperator extends Operator {
	 ...
	 * <p>
	 * This operator implementation gets a variable number arguments but not less than two. First argument is always the minuend
	 * from which the others, the subtrahends are subtracted.
	 * 
	 * <pre>
	 *    (sub 20px 2px) -> 18px
	 *    (sub 20 2px)   -> 18px
	 ...
	 * @throws IllegalArgumentException if arguments is null or arguments count is less than two or have different measurement
	 *             units.
	 */
	@Override
