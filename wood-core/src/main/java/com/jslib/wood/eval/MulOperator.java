...
class MulOperator extends Operator {
	 ...
	 * <p>
	 * This operator implementation gets a variable number arguments but not less than two. Apply multiply operation on all.
	 * Since multiplication is commutative arguments order is not relevant.
	 * 
	 * <pre>
	 *    (mul 2px 20px) -> 40px
	 *    (mul 2 20px)   -> 40px
