...
public class Variants {
     ...
     * generate old ones. For example a hebrew file can use both <code>iw</code> and <code>he</code> code language variant but
    ...
    /**
     * Test if these variants has requested language. Language parameter may be null if projects is not multi-language. Returns
     ...
     * @return true if these variants has <code>language</code>.
     * @see #language
     */
     ...
     *
     * @return true if this variants instance is empty.
     * @see #empty
     */
